...
#for showing signup/login button for admin(by group7)
...
#for showing signup/login button for doctor(by group7)
...
#for showing signup/login button for patient(by group7)
...
#-----------for checking user is doctor , patient or admin(by group7)
def is_admin(user):
